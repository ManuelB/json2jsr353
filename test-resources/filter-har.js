...
// Example:
// :!./% example.com.har.json 'function filter(oEntry) { return oEntry.request.url.match(/$/)  && oEntry.request.method === "POST"; }' 'function map(oEntry) { delete oEntry.response.content.text; return oEntry; }' | python -m json.tool > only-batch-post-without-content-example.com.har.json
