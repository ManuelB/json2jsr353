...
QUnit.test("JSON2JSR353 ", function(assert) {
    let json2jsr353 = new JSON2JSR353();
    let s = "5a418a05-27aa-c286-973f-1887cef498ce  5a418a05-27aa-c286-973f-1887cef498ce \n '5a418a05-27aa-c286-973f-1887cef498ce 9d3215c6-b472-3d1c-5751-1dc4d37f879f\n";
    assert.equal(json2jsr353.replaceUUIDsWithVariables(s), "		String uuid1 = UUID.randomUUID().toString();\n		String uuid2 = UUID.randomUUID().toString();\n\"+uuid1+\"  \"+uuid1+\" \n '\"+uuid1+\" \"+uuid2+\"\n");
});
QUnit.test("JSON2JSR353 convertHAR2Java", function(assert) {
    ...
    assert.equal(sResult, "import static org.junit.Assert.assertEquals;\nimport org.junit.Test;\n\nimport javax.ws.rs.client.Client;\nimport javax.ws.rs.client.ClientBuilder;\nimport javax.ws.rs.client.Entity;\nimport javax.ws.rs.core.Response;\n\nimport javax.json.Json;\nimport javax.json.JsonObject;\nimport javax.json.JsonValue;\n\nimport org.glassfish.jersey.filter.LoggingFilter;\n\nimport java.util.UUID;\nimport java.util.logging.Logger;\n\npublic class HARRequestExecuterTest {\n	public static Client client() {\n		Client client = ClientBuilder.newClient();\n		client.register(new LoggingFilter(Logger.getLogger(LoggingFilter.class.getName()), true));\n		return client;\n	}\n\n	public static void executeRequest0() {\n		Client client = client();\n		String uuid1 = UUID.randomUUID().toString();\n		String uuid2 = UUID.randomUUID().toString();\n		String uuid3 = UUID.randomUUID().toString();\n		String uuid4 = UUID.randomUUID().toString();\n		String uuid5 = UUID.randomUUID().toString();\n		String uuid6 = UUID.randomUUID().toString();\n		String uuid7 = UUID.randomUUID().toString();\n		String uuid8 = UUID.randomUUID().toString();\n		String uuid9 = UUID.randomUUID().toString();\n		String uuid10 = UUID.randomUUID().toString();\n		String uuid11 = UUID.randomUUID().toString();\n		String uuid12 = UUID.randomUUID().toString();\n		String postData0 = \"\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Aussaats('\"+uuid1+\"')/RessourceDetails?$skip=1&$top=999 HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: application/json\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Einheits/$count?$filter=Visible%20eq%20true%20and%20Id%20eq%20%27\"+uuid2+\"%27 HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: text/plain, */*;q=0.5\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Einheits?$skip=0&$top=1000&$orderby=EinheitKategorieDetails/Id%20asc,KurzBezeichnung%20asc&$filter=Visible%20eq%20true%20and%20Id%20eq%20%27\"+uuid2+\"%27 HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: application/json\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Einheits/$count?$filter=Visible%20eq%20true%20and%20(EinheitKategorieDetails/Id%20eq%20%27\"+uuid3+\"%27%20or%20EinheitKategorieDetails/Id%20eq%20%27\"+uuid4+\"%27) HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: text/plain, */*;q=0.5\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Einheits?$skip=0&$top=1000&$orderby=EinheitKategorieDetails/Id%20asc,KurzBezeichnung%20asc&$filter=Visible%20eq%20true%20and%20(EinheitKategorieDetails/Id%20eq%20%27\"+uuid3+\"%27%20or%20EinheitKategorieDetails/Id%20eq%20%27\"+uuid4+\"%27) HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: application/json\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Verfahrens/$count?$filter=(Id%20eq%20%27\"+uuid5+\"%27%20or%20Id%20eq%20%27\"+uuid6+\"%27%20or%20Id%20eq%20%27\"+uuid7+\"%27%20or%20Id%20eq%20%27\"+uuid8+\"%27%20or%20Id%20eq%20%27\"+uuid9+\"%27%20or%20Id%20eq%20%27\"+uuid10+\"%27%20or%20Id%20eq%20%27\"+uuid11+\"%27%20or%20Id%20eq%20%27\"+uuid12+\"%27) HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: text/plain, */*;q=0.5\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		postData0 += \"--batch_270b-f0a8-fded\";\n		postData0 += \"\\r\\nContent-Type: application/http\\r\\nContent-Transfer-Encoding: binary\";\n		postData0 += \"GET Verfahrens?$skip=0&$top=1000&$orderby=Name%20asc&$filter=(Id%20eq%20%27\"+uuid5+\"%27%20or%20Id%20eq%20%27\"+uuid6+\"%27%20or%20Id%20eq%20%27\"+uuid7+\"%27%20or%20Id%20eq%20%27\"+uuid8+\"%27%20or%20Id%20eq%20%27\"+uuid9+\"%27%20or%20Id%20eq%20%27\"+uuid10+\"%27%20or%20Id%20eq%20%27\"+uuid11+\"%27%20or%20Id%20eq%20%27\"+uuid12+\"%27)&$expand=Massnahmeart2VerfahrenDetails HTTP/1.1\\r\\nsap-contextid-accept: header\\r\\nAccept: application/json\\r\\nAccept-Language: en\\r\\nDataServiceVersion: 2.0\\r\\nMaxDataServiceVersion: 2.0\\r\\nsap-cancel-on-close: true\";\n		postData0 += \"\\r\\n\";\n		\n		Response response = client.target(\"https://example.com\").path(\"/application/Agrar.svc/$batch\").request().header(\"content-type\", \"multipart/mixed;boundary=batch_270b-f0a8-fded\").header(\"accept\", \"application/json\").post(Entity.text(postData0));\n\n		assertEquals(202, response.getStatus());\n	}\n	@Test\n	public void test() {\n		main(null);\n	}\n	public static void main(String[] args) {\n		executeRequest0();\n	}\n}");
});